<template>
  <div class="new-game m-b10">
    ...
    >
      ...
      <div class="list-btn" slot="wordAfter" slot-scope="{ itemData }">
        <router-link slot="wordAfter" :to="itemData.btnPath">专区</router-link>
      </div>
    </List>
  </div>
</template>
